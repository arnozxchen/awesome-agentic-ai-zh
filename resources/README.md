...
| [`mcp-skills-catalog.md`](mcp-skills-catalog.md) | **54 個整合 catalog** | 想把 Claude Code 接 Notion / Obsidian / Excel / Postgres / Slack / 等等實際工具 | ~775 |
...
→ [`mcp-skills-catalog.md`](mcp-skills-catalog.md)（54 個整合分 14 類）
